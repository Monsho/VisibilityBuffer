...
if __name__ == '__main__':
    ...
    JOINED_FILE = "LargeResource.zip" # 結合後のファイル名
    ...
    # zipファイルが正常に結合されたら展開する
    if os.path.exists(JOINED_FILE):
        extract_to_path = os.path.dirname(JOINED_FILE)
        try:
            with zipfile.ZipFile(JOINED_FILE, 'r') as zip_ref:
                zip_ref.extractall(extract_to_path)
            print("\n" + "="*10 + " END ZIP EXTRACT " + "="*10)
        except Exception as e:
            print("Error!! {e}")
