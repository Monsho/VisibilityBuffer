...
static const char* kShaderFileAndEntry[] = {
	...
	"water.vv.hlsl",					"main",
	"water_uniform.p.hlsl",				"main",
	"water_newton.p.hlsl",				"main",
	"water_newton_face.p.hlsl",			"main",
	"water_raymarch.p.hlsl",			"main",
	"water_mipmap.c.hlsl",				"main",
	"rt_test.lib.hlsl",					"main",
	"rt_probe_trace.lib.hlsl",			"main",
	"rt_monte_carlo_gi.lib.hlsl",		"main",
	"rt_restir_gi.lib.hlsl",			"main",
	"rt_spatial_reuse.c.hlsl",			"main",
	"rt_resolve_gi.c.hlsl",				"main",
	"rt_material.lib.hlsl",				"main",
	"apply_ddgi.c.hlsl",				"main",
	"svgf_prepass.c.hlsl",				"main",
	"svgf_temporal.c.hlsl",				"main",
	"svgf_atrous.c.hlsl",				"main",
	"debug.p.hlsl",						"main",
